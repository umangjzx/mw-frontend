...
//         return await GetAPI(endpoints.volunteer.getAllVolunteers).then((res: any) => {
//             return res;
//         });
//     };
...
//             volunteer.volunteer_service_type.toLowerCase().includes(searchQuery.toLowerCase())
//     );
...
//             <h1 className="text-2xl font-bold text-black mb-5 text-center">Find a Volunteer</h1>
...
//                     <div key={volunteer.volunteer_id} className="bg-white p-4 rounded-lg shadow-md">
//                         <h2 className="text-lg font-bold mb-2">{volunteer.volunteer_name}</h2>
