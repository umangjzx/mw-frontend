...
//         return await GetAPI(endpoints.session.getLearnerSessions(learner_id)).then((res: any) => {
//             return res;
//         });
//     };
...
//             session.session_description.toLowerCase().includes(searchQuery.toLowerCase())
//     );
...
//             <h1 className="text-2xl font-bold text-black mb-5 text-center">Learning Sessions</h1>
...
//                     <div key={session.session_id} className="bg-white p-4 rounded-lg shadow-md">
