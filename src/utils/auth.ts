...
export const isAuthenticated = () => {
    ...
    return token && refresh_token && onboarded_status && (role === "learner" || role === "volunteer") && (role === "learner" ? learner_id : volunteer_id);
};
...
export const isCookiesFound = (cookies: any) => {
    ...
    const cookiesFound = token && role && refresh_token && onboarded_status && (role === "learner" ? learner_id : volunteer_id);
