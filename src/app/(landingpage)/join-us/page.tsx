    ...
    return (
        <div className="w-full bg-background-input min-h-screen">
            <div className="max-w-[1200px] mx-auto px-6 md:px-8 lg:px-12 py-5 md:py-16 lg:py-20">
                ...
                <div className="bg-white rounded-[24px] lg:py-10 py-6" style={{ borderRadius: '24px' }}>
                    ...
                    <div className="w-full mb-5 md:mb-10 lg:mb-12 overflow-hidden px-4 md:px-10">
                        <div className="relative w-full h-[160px] lg:h-[400px] bg-gray-200 rounded-[24px] overflow-hidden mx-auto md:mx-0" style={{ borderRadius: '24px' }}>
                            <Image
                                src={image1}
