    ...
    setEventDetails: (details: any) => {
        ...
        set({
            eventDetails: {
                ...
                volunteer_name: eventDetails?.volunteer_full_name || eventDetails?.volunteer?.firstName && `${eventDetails?.volunteer?.firstName} ${eventDetails?.volunteer?.lastName}`,
                learner_name: eventDetails?.learner_full_name || eventDetails?.learner?.firstName && `${eventDetails?.learner?.firstName} ${eventDetails?.learner?.lastName}`,
            },
        });
    },
