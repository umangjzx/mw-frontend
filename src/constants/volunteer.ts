...
export const ContactDetailsFields: FormField[] = [
    ...
    },
    {
        ...
        options: [
            ...
            { label: "America/Anchorage (UTC-09:00)", value: "UTC-09:00" },
            { label: "America/Los_Angeles (UTC-08:00)", value: "UTC-08:00" },
            { label: "America/Denver (UTC-07:00)", value: "UTC-07:00" },
            { label: "America/Chicago (UTC-06:00)", value: "UTC-06:00" },
            { label: "America/New_York (UTC-05:00)", value: "UTC-05:00" },
            { label: "America/Halifax (UTC-04:00)", value: "UTC-04:00" },
            { label: "America/St_Johns (UTC-03:30)", value: "UTC-03:30" },
            { label: "America/Sao_Paulo (UTC-03:00)", value: "UTC-03:00" },
            { label: "Atlantic/South_Georgia (UTC-02:00)", value: "UTC-02:00" },
            { label: "Atlantic/Azores (UTC-01:00)", value: "UTC-01:00" },
            { label: "UTC (UTC+00:00)", value: "UTC+00:00" },
            { label: "Europe/London (UTC+00:00)", value: "UTC+00:00" },
            { label: "Europe/Paris (UTC+01:00)", value: "UTC+01:00" },
            { label: "Europe/Istanbul (UTC+03:00)", value: "UTC+03:00" },
            { label: "Asia/Tehran (UTC+03:30)", value: "UTC+03:30" },
            { label: "Asia/Dubai (UTC+04:00)", value: "UTC+04:00" },
            { label: "Asia/Kolkata (UTC+05:30)", value: "UTC+05:30" },
            { label: "Asia/Kathmandu (UTC+05:45)", value: "UTC+05:45" },
            { label: "Asia/Jakarta (UTC+07:00)", value: "UTC+07:00" },
            { label: "Asia/Shanghai (UTC+08:00)", value: "UTC+08:00" },
            { label: "Asia/Tokyo (UTC+09:00)", value: "UTC+09:00" },
            { label: "Australia/Sydney (UTC+10:00)", value: "UTC+10:00" },
            { label: "Pacific/Auckland (UTC+12:00)", value: "UTC+12:00" }
        ],        
        gridCols: 1,
        inputClassName: "!w-full",
        required: true,
