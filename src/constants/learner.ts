...
const BehaviorSocialFields: FormField[] = [
    ...
    },
    {
        ...
        gridCols: 1,
        options: [
            { label: "Difficulty in Social Interaction", value: "difficulty_in_social_interaction" },
            ...
            { label: "Difficulty in Adapting to Changes", value: "difficulty_in_adapting_to_changes" },
            { label: "Sensory Sensitivities (e.g., to Sound, Touch, or Light)", value: "sensory_sensitivities" },
            { label: "Short Attention Span", value: "short_attention_span" },
            { label: "Impulsivity", value: "impulsivity" },
            { label: "Difficulty in Understanding Social Cues", value: "difficulty_in_understanding_social_cues" },
            { label: "Aggressive Behaviors or Tantrums", value: "aggressive_behaviors_or_tantrums" },
            { label: "Self-Stimulatory Behaviors (e.g., Hand Flapping, Rocking)", value: "self_stimulatory_behaviors" },
            { label: "Difficulty in Maintaining Eye Contact", value: "difficulty_in_maintaining_eye_contact" },
            { label: "Fixation on Specific Objects or Topics", value: "fixation_on_specific_objects_or_topics" },
            { label: "Difficulty in Following Instructions", value: "difficulty_in_following_instructions" },
            { label: "Challenges in Emotional Regulation", value: "challenges_in_emotional_regulation" },
            { label: "High Levels of Anxiety or Fear", value: "high_levels_of_anxiety_or_fear" },
            { label: "Oppositional or Defiant Behaviors", value: "oppositional_or_defiant_behaviors" },
            { label: "Excessive Dependence on Routines or Rituals", value: "excessive_dependence_on_routines_or_rituals" },
            { label: "Easily Overwhelmed in Group Settings", value: "easily_overwhelmed_in_group_settings" },
            { label: "Difficulty in Forming Peer Relationships", value: "difficulty_in_forming_peer_relationships" },
